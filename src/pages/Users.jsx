...
export default function Users() {
  ...
  return (
    <div className="p-4">
      ...
      <div className="overflow-hidden rounded-lg shadow-xs border border-gray-200">
        {/* Table Header */}
        <div className="flex justify-between items-center bg-gray-50 px-6 py-4">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="border border-gray-300 p-2 rounded-md focus:ring-2 focus:ring-gray-400 outline-none text-gray-700"
              value={search}
              onChange={(e) => setSearch(e.target.value)}
            />
            <Link
              to="/users/add"
              className="flex items-center space-x-2 bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 transition text-sm"
            >
